...
internal static class DbSeeder
{
    ...
    [
        ...
        ("SL.Override.NIFTY",       "0",   SettingType.Decimal, "Override SL points for NIFTY (0 = off)"),
        ("Target.Points.NIFTY",     "35",  SettingType.Decimal, "Default Target points for NIFTY"),
        ("Target.Override.NIFTY",   "15",  SettingType.Decimal, "Override Target points for NIFTY (0 = off)"),
        ("SL.Points.BANKNIFTY",     "40",  SettingType.Decimal, "Default SL points for BANKNIFTY"),
        ("SL.Override.BANKNIFTY",   "0",   SettingType.Decimal, "Override SL points for BANKNIFTY (0 = off)"),
        ("Target.Points.BANKNIFTY", "70",  SettingType.Decimal, "Default Target points for BANKNIFTY"),
        ("Target.Override.BANKNIFTY","15", SettingType.Decimal, "Override Target points for BANKNIFTY (0 = off)"),
        ("SL.Points.FINNIFTY",      "20",  SettingType.Decimal, "Default SL points for FINNIFTY"),
        ("SL.Override.FINNIFTY",    "0",   SettingType.Decimal, "Override SL points for FINNIFTY (0 = off)"),
        ("Target.Points.FINNIFTY",  "35",  SettingType.Decimal, "Default Target points for FINNIFTY"),
        ("Target.Override.FINNIFTY","15",  SettingType.Decimal, "Override Target points for FINNIFTY (0 = off)"),
        ("SL.Points.MIDCPNIFTY",    "15",  SettingType.Decimal, "Default SL points for MIDCPNIFTY"),
        ("SL.Override.MIDCPNIFTY",  "0",   SettingType.Decimal, "Override SL points for MIDCPNIFTY (0 = off)"),
        ("Target.Points.MIDCPNIFTY","25",  SettingType.Decimal, "Default Target points for MIDCPNIFTY"),
        ("Target.Override.MIDCPNIFTY","15",SettingType.Decimal, "Override Target points for MIDCPNIFTY (0 = off)"),
        ("SL.Points.SENSEX",        "80",  SettingType.Decimal, "Default SL points for SENSEX"),
        ("SL.Override.SENSEX",      "0",   SettingType.Decimal, "Override SL points for SENSEX (0 = off)"),
        ("Target.Points.SENSEX",    "140", SettingType.Decimal, "Default Target points for SENSEX"),
        ("Target.Override.SENSEX",  "15",  SettingType.Decimal, "Override Target points for SENSEX (0 = off)"),
        ("SL.Points.BANKEX",        "90",  SettingType.Decimal, "Default SL points for BANKEX"),
        ("SL.Override.BANKEX",      "0",   SettingType.Decimal, "Override SL points for BANKEX (0 = off)"),
        ("Target.Points.BANKEX",    "150", SettingType.Decimal, "Default Target points for BANKEX"),
        ("Target.Override.BANKEX",  "15",  SettingType.Decimal, "Override Target points for BANKEX (0 = off)"),
        ...
        ("SL.Override.CRUDEOIL",     "0",   SettingType.Decimal, "Override SL points for CRUDEOIL (0 = off)"),
        ("Target.Points.CRUDEOIL",   "30",  SettingType.Decimal, "Default Target points for CRUDEOIL"),
        ("Target.Override.CRUDEOIL", "15",  SettingType.Decimal, "Override Target points for CRUDEOIL (0 = off)"),
        ("SL.Points.NATURALGAS",     "5",   SettingType.Decimal, "Default SL points for NATURALGAS"),
        ("SL.Override.NATURALGAS",   "0",   SettingType.Decimal, "Override SL points for NATURALGAS (0 = off)"),
        ("Target.Points.NATURALGAS", "10",  SettingType.Decimal, "Default Target points for NATURALGAS"),
        ("Target.Override.NATURALGAS","15", SettingType.Decimal, "Override Target points for NATURALGAS (0 = off)"),
        ("SL.Points.GOLD",           "60",  SettingType.Decimal, "Default SL points for GOLD"),
        ("SL.Override.GOLD",         "0",   SettingType.Decimal, "Override SL points for GOLD (0 = off)"),
        ("Target.Points.GOLD",       "120", SettingType.Decimal, "Default Target points for GOLD"),
        ("Target.Override.GOLD",     "15",  SettingType.Decimal, "Override Target points for GOLD (0 = off)"),
        ("SL.Points.SILVER",         "50",  SettingType.Decimal, "Default SL points for SILVER"),
        ("SL.Override.SILVER",       "0",   SettingType.Decimal, "Override SL points for SILVER (0 = off)"),
        ("Target.Points.SILVER",     "100", SettingType.Decimal, "Default Target points for SILVER"),
        ("Target.Override.SILVER",   "15",  SettingType.Decimal, "Override Target points for SILVER (0 = off)"),
        // ---------------------------------------------------------------------------
        ...
        ("RiskAutoSquareOffEnabled", "true", SettingType.Boolean, "Automatically square off all open positions for an account when its Daily Max Profit or Daily Max Loss is hit"),
        ...
        ("SlippageGuardEnabled", defaultvalue, SettingType.Boolean, "Reject orders when CMP has slipped beyond the allowed % from the signal entry price (applies to Live and Paper)"),
